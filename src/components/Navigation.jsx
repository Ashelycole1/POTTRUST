...
import { Home, Users, Landmark, TrendingUp, FileText, Settings, Bell, Upload, Plus, Menu } from 'lucide-react';
...
export const MobileBottomNav = ({ role }) => {
  ...
  if (role === 'Admin') return null; // Admins usually don't have this simple mobile nav in this design
